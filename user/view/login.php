<div class="row g-0 app-auth-wrapper">
		    ...
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
			        ...
			        <div class="auth-form-container text-start">
						...
						<div class="auth-option text-center pt-5">No Account? Sign up <a class="text-link" href="indexclient.php?act=logup" >here</a>.</div>
	    ...
	    <div class="col-12 col-md-5 col-lg-6 h-100 auth-background-col">
		    ...
		    <div class="auth-background-mask">
				<img style="width: 100%; height: 100%"src="https://png.pngtree.com/element_our/20200703/ourlarge/pngtree-cute-contrast-color-cartoon-animal-little-dinosaur-image_2300437.jpg" alt="">
			</div>

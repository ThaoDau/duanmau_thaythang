<main style="margin-top: 20px;">
    ...
    <section >
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <p class="small"><a href="indexclient.php?act=detail_products" class="text-muted">Laptops</a></p>
                                            <p class="small text-danger"><s>$1099</s></p>
                                        </div>

                                        <div class="d-flex justify-content-between mb-3">
                                            <h5 class="mb-0"><a href="indexclient.php?act=detail_products">HP Notebook</a></h5>
        ...
        <div class="left-main">
            <?php include "../user/view/boxright.php" ?>
        </div>
    </div>
</main>
